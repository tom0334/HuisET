...
class HistoryPersonRecAdapter(val items : MutableList<Person?>, val context: Context, val realm: Realm) : RecyclerView.Adapter<HistoryPersonViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HistoryPersonViewHolder {
        return HistoryPersonViewHolder(LayoutInflater.from(context).inflate(R.layout.history_person_rec_item, parent, false))
    }
